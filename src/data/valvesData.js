...
// פונקציית עזר לחישוב ממוצע עבור מידה 2.5 אינץ'
...
const PRICES_STD_USD_RAW = {
  ...
  "FDV-R-HH0": { '1.5"': 1325, '2"': 1325, '2.5"': 1417, '3"': 1510 },
  "FDV-R-HHP": { '1.5"': 1636, '2"': 1636, '2.5"': 1729, '3"': 1822 },
  "FDV-R-MH0": {
    '1.5"': 972,
    '2"': 972,
    '2.5"': 1048,
...
export const PRICES_STD_USD = addSize2_5(PRICES_STD_USD_RAW);
export const PRICES_HG_USD = addSize2_5(PRICES_HG_USD_RAW);
export const PRICES_STD_EUR = addSize2_5(PRICES_STD_EUR_RAW);
export const PRICES_HG_EUR = addSize2_5(PRICES_HG_EUR_RAW);
